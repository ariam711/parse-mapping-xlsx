...
const maxChunkSize = Number(process.env.MAX_CHUNK_SIZE || 350000);
const minChunkSize = Number(process.env.MIN_CHUNK_SIZE || 200000);
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // default style library used for generating CSS styles for Material-UI components
      ...
      rules: [
        ...
        },
        {
          ...
          use: {
            loader: 'babel-loader',
            query: {
              plugins: [[require('babel-plugin-direct-import'), { modules: ['@mui/material', '@mui/lab'] }]]
            }
          }
        },
        {
    ...
    plugins: [
      ...
      new webpack.ContextReplacementPlugin(/dayjs[/\\]locale$/, /(es|en)/)
    ].filter(Boolean),
